...
# load from saved
model = torch.load("results/Rot-UM-Mag-[data_64]"+idx+".pth").to(device)
best_model = model
...
for i in range(100):
    ...
    if valid_mse[-1] < min_mse:
        min_mse = valid_mse[-1] 
        best_model = model
        torch.save(model, "results/Rot-UM-Mag-[data_64]"+idx+".pth")
    end = time.time()
...
torch.save({"preds": preds,
            ...
            "results/Rot-UM-Mag-[data_64-data_64]"+idx+".pt")
...
torch.save({"preds": preds,
            ...
            "test_mse":test_mse,
            "loss_curve": loss_curve}, 
            "results/Rot-UM-Mag-[data_64-um_64]"+idx+".pt")
...
torch.save({"preds": preds,
            ...
            "test_mse":test_mse,
            "loss_curve": loss_curve}, 
            "results/Rot-UM-Mag-[data_64-rot_92]"+idx+".pt")
...
torch.save({"preds": preds,
            ...
            "test_mse":test_mse,
            "loss_curve": loss_curve}, 
            "results/Rot-UM-Mag-[data_64-mag_64]"+idx+".pt")
...
torch.save({"preds": preds,
            ...
            "test_mse":test_mse,
            "loss_curve": loss_curve}, 
            "results/Rot-UM-Mag-[data_64-scale_128]"+idx+".pt")
...
torch.save({"preds": preds,
            ...
            "test_mse":test_mse,
            "loss_curve": loss_curve}, 
            "results/Rot-UM-Mag-[data_64-rot_um_mag_92]"+idx+".pt")
...
torch.save({"preds": preds,
            ...
            "test_mse":test_mse,
            "loss_curve": loss_curve}, 
            "results/Rot-UM-Mag-[data_64-scale_rot_um_182]"+idx+".pt")
