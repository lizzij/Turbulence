...
train_direc = "/global/cscratch1/sd/roseyu/Eliza/TF-net/Data/rot_um_mag_64/sample_"
idx = str(1)
num_layers = 2
kernel_size = 3
hidden_dim = 128
...
# test_direc = "/global/cscratch1/sd/roseyu/Eliza/TF-net/Data/rot_um_mag_64/sample_"
# test_set = Dataset(test_indices, input_length, 40, 10, test_direc, True)
# test_loader = data.DataLoader(test_set, batch_size = batch_size, shuffle = False, num_workers = 8)
# test_mse, preds, trues, loss_curve = test_epoch(test_loader, best_model, loss_fun)
...
#             "test_mse":test_mse,
#             "loss_curve": loss_curve}, 
#             "Rot-UM-Mag-CNN-Org-Rot-UM-Mag"+idx+".pt")

# print('Rot-UM-Mag-CNN-Org-Rot-UM-Mag:',test_mse)
...
torch.save({"preds": preds,
            ...
            "test_mse":test_mse,
            "loss_curve": loss_curve}, 
            "Rot-UM-Mag-CNN-Rot-UM-Rot-UM-Mag"+idx+".pt")

print('Rot-UM-Mag-CNN-Rot-UM-Rot-UM-Mag:',test_mse)